...
tf.compat.v1.app.flags.DEFINE_string('original_image', None, 'Path to PNG image.')
tf.compat.v1.app.flags.DEFINE_string('compared_image', None, 'Path to PNG image.')
...
def main(_):
  ...
  decoded_image = tf.expand_dims(tf.compat.v1.image.decode_jpeg(contents = input_img, channels=3), 0)
